...
# d'
dprime = df
dprime["measure", "d_prime"] = stats.norm.ppf(dprime["proportions", "p_hit"]) - stats.norm.ppf(dprime["proportions", "p_fa"])
...
# criterion location
relcrit = df
relcrit["measure", "criterion"] = -0.5 * (stats.norm.ppf(relcrit["proportions", "p_hit"]) + stats.norm.ppf(relcrit["proportions", "p_fa"]))
